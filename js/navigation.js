// Navigation Module - Complete with page routing, dialog system, post detail view
...
function navigate(page, data) {
    ...
    // Diary redirects to separate page
    if (page === 'diary') {
    ...
    if (bottomNav) {
        if (S.username && authPages.indexOf(page) === -1) {
...
function showDialog(options) {
    return new Promise(function(resolve) {
        ...
        // Focus input if not HTML subtitle
        if (!options.htmlSubtitle) {
            setTimeout(function() {
                input.focus();
...
// ============================================================
// POST DETAIL VIEW - Maximized with back button
// ============================================================
